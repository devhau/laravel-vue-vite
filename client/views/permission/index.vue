<template>
    <vh-page>
        <h3>{{ $t("module.permission.title") }}</h3>
        <manager :option="option">
            ...
            <template #form_update="{ data, isNew }">
                <div class="mb-3">
                    <label for="idName" class="form-label">Mã quyền</label>
                    <vh-input
                        id="idName"
                        :disabled="!isNew"
                        v-model="data.name"
                ...
                <div class="mb-3">
                    <label for="idtitle" class="form-label">Tên quyền</label>
                    <vh-input
                        id="idtitle"
                        v-model="data.title"
                        placeholder="title"
                ...
                <div class="mb-3">
                    <label for="idmodule" class="form-label">Tên module</label>
                    <vh-input
                        id="idmodule"
                        v-model="data.module"
                        placeholder="module"
                ...
                <div class="mb-3">
                    <label for="idguard_name" class="form-label"
                        >Tên guard</label
                    >
                    <vh-input
                        id="idguard_name"
